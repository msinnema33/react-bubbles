...
- [x] Explain what a token is used for.
    ...
    Tokens are used for our Apps to prove to the server that it is authenticated with them.  The server issues the token in exchange for correct login credentials.
